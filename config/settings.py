...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "74*tl-)jkz$ej5a7=ewrm*@+gq8qr4vdim7(@2c=47)@8#6p9#"
)
...
ALLOWED_HOSTS = [] if DEBUG else [".elasticbeanstalk.com"]  # TODO: Edit
...
if not DEBUG:
    ...
    AWS_STORAGE_BUCKET_NAME = "airbnb-clone-storage-001"
